...
* 通常用于关闭歌词页面
*/
const onClickControlThumbAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onClickControlThumbAtom", (0, jotai.atom)(c(() => {})));
/**
* 点击音质标签时触发
*
* 通常用于打开音质详情对话框
...
const onClickAudioQualityTagAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onClickAudioQualityTagAtom", (0, jotai.atom)(c(() => {})));
/**
* 点击菜单按钮时触发
*/
onClickAudioQualityTagAtom.debugLabel = "onClickAudioQualityTagAtom";
const onRequestOpenMenuAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onRequestOpenMenuAtom", (0, jotai.atom)(c(() => {})));
/**
* 点击暂停或播放按钮时触发
*/
onRequestOpenMenuAtom.debugLabel = "onRequestOpenMenuAtom";
const onPlayOrResumeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onPlayOrResumeAtom", (0, jotai.atom)(c(() => {})));
/**
* 点击上一首按钮时触发
*/
onPlayOrResumeAtom.debugLabel = "onPlayOrResumeAtom";
const onRequestPrevSongAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onRequestPrevSongAtom", (0, jotai.atom)(c(() => {})));
/**
* 点击下一首按钮时触发
*/
onRequestPrevSongAtom.debugLabel = "onRequestPrevSongAtom";
const onRequestNextSongAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onRequestNextSongAtom", (0, jotai.atom)(c(() => {})));
/**
* 拖动进度条触发跳转时触发
* @param position - 目标播放位置，单位为毫秒
*/
onRequestNextSongAtom.debugLabel = "onRequestNextSongAtom";
const onSeekPositionAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onSeekPositionAtom", (0, jotai.atom)(c((_position) => {})));
/**
* 当某个歌词行被左键点击时触发
...
const onLyricLineClickAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onLyricLineClickAtom", (0, jotai.atom)(c((_evt, _playerRef) => {})));
/**
* 当某个歌词行被右键点击时触发
* @param _evt 歌词行的事件对象，可以访问到对应的歌词行信息和歌词行索引
* @param _playerRef 歌词播放组件的引用
...
const onLyricLineContextMenuAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onLyricLineContextMenuAtom", (0, jotai.atom)(c((_evt, _playerRef) => {})));
/**
* 通过音量滑块改变音量时触发
* @param volume - 目标音量，取值范围为 [0-1]
*/
onLyricLineContextMenuAtom.debugLabel = "onLyricLineContextMenuAtom";
const onChangeVolumeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onChangeVolumeAtom", (0, jotai.atom)(c((_volume) => {})));
/**
* 点击随机按钮时触发
*/
onChangeVolumeAtom.debugLabel = "onChangeVolumeAtom";
const onToggleShuffleAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onToggleShuffleAtom", (0, jotai.atom)(c(() => {})));
/**
* 点击循环按钮时触发
*/
onToggleShuffleAtom.debugLabel = "onToggleShuffleAtom";
const onCycleRepeatModeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\callbacks.ts/onCycleRepeatModeAtom", (0, jotai.atom)(c(() => {})));
...
*/
const lyricPlayerImplementationAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricPlayerImplementationAtom", (0, jotai.atom)(getInitialPlayerImplementation()));
/**
* 是否启用歌词行模糊效果
*
* 性能影响：较高
...
const enableLyricLineBlurEffectAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/enableLyricLineBlurEffectAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.enableLyricLineBlurEffect", true));
/**
* 是否启用歌词行缩放效果
*
* 性能影响：无
...
const enableLyricLineScaleEffectAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/enableLyricLineScaleEffectAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.enableLyricLineScaleEffect", true));
/**
* 是否使用物理弹簧算法实现歌词动画效果
*
...
const enableLyricLineSpringAnimationAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/enableLyricLineSpringAnimationAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.enableLyricLineSpringAnimation", true));
/**
* 是否显示翻译歌词行
*
* 性能影响：无
...
const enableLyricTranslationLineAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/enableLyricTranslationLineAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.enableLyricTranslationLine", true));
/**
* 是否显示音译歌词行
*
* 性能影响：无
...
const enableLyricRomanLineAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/enableLyricRomanLineAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.enableLyricRomanLine", true));
/**
* 是否交换音译和翻译歌词行的显示位置
*
* 性能影响：无
...
const enableLyricSwapTransRomanLineAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/enableLyricSwapTransRomanLineAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.enableLyricSwapTransRomanLine", false));
/**
...
const lyricWordFadeWidthAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricWordFadeWidthAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricWordFadeWidth", .5));
/**
* 设置歌词组件的字体家族
*
...
const lyricFontFamilyAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricFontFamilyAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricFontFamily", ""));
/**
* 设置歌词组件的字体字重
*
...
const lyricFontWeightAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricFontWeightAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricFontWeight", 600));
/**
* 设置歌词组件的字符间距
*
...
const lyricLetterSpacingAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricLetterSpacingAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricLetterSpacing", "normal"));
/**
* 设置歌词的字体大小
* @default LyricSizePreset.Medium
*/
lyricLetterSpacingAtom.debugLabel = "lyricLetterSpacingAtom";
const lyricSizePresetAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricSizePresetAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricSizePreset", "medium"));
/**
* 播放控制组件的显示类型，即歌曲信息下方的组件
*/
lyricSizePresetAtom.debugLabel = "lyricSizePresetAtom";
const playerControlsTypeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/playerControlsTypeAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.playerControlsType", "controls"));
/**
* 是否显示歌曲名称
* @default true
*/
playerControlsTypeAtom.debugLabel = "playerControlsTypeAtom";
const showMusicNameAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/showMusicNameAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.showMusicName", true));
/**
* 在隐藏歌词的情况下专辑图的布局方式
* @default VerticalCoverLayout.Auto
*/
showMusicNameAtom.debugLabel = "showMusicNameAtom";
const verticalCoverLayoutAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/verticalCoverLayoutAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.verticalCoverLayout", "auto"));
/**
* 是否显示歌曲作者
* @default true
*/
verticalCoverLayoutAtom.debugLabel = "verticalCoverLayoutAtom";
const showMusicArtistsAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/showMusicArtistsAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.showMusicArtists", true));
/**
* 是否显示歌曲专辑名称
*
...
const showMusicAlbumAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/showMusicAlbumAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.showMusicAlbum", false));
/**
* 是否显示音量控制条
* @default true
*/
showMusicAlbumAtom.debugLabel = "showMusicAlbumAtom";
const showVolumeControlAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/showVolumeControlAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.showVolumeControl", true));
/**
* 是否显示底部控制按钮组
*
...
const showBottomControlAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/showBottomControlAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.showBottomControl", true));
...
* 配置所使用的歌词背景渲染器
*/
const lyricBackgroundRendererAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricBackgroundRendererAtom", (0, jotai.atom)(getInitialBackgroundRenderer()));
/**
* 当背景渲染器设置为纯色或CSS背景时，使用此值
* @default "#111111"
*/
lyricBackgroundRendererAtom.debugLabel = "lyricBackgroundRendererAtom";
const cssBackgroundPropertyAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/cssBackgroundPropertyAtom", (0, jotai_utils.atomWithStorage)("amll-player.cssBackgroundProperty", "#111111"));
/**
...
const lyricBackgroundFPSAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricBackgroundFPSAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricBackgroundFPS", 60));
/**
...
const lyricBackgroundRenderScaleAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricBackgroundRenderScaleAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricBackgroundRenderScale", 1));
/**
* 是否启用背景静态模式
*
...
const lyricBackgroundStaticModeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/lyricBackgroundStaticModeAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.lyricBackgroundStaticMode", false));
/**
* 控制歌词播放页面是否可见
*/
lyricBackgroundStaticModeAtom.debugLabel = "lyricBackgroundStaticModeAtom";
const isLyricPageOpenedAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/isLyricPageOpenedAtom", (0, jotai.atom)(false));
/**
* 是否隐藏歌词视图（即使有歌词数据）
* @default false
*/
isLyricPageOpenedAtom.debugLabel = "isLyricPageOpenedAtom";
const hideLyricViewAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/hideLyricViewAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.hideLyricView", false));
/**
* 是否在进度条上显示剩余时间而非当前时间
* @default true
*/
hideLyricViewAtom.debugLabel = "hideLyricViewAtom";
const showRemainingTimeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/showRemainingTimeAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.showRemainingTime", true));
/**
* 音频可视化频域范围
*
...
const fftDataRangeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\configAtoms.ts/fftDataRangeAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.fftDataRange", [80, 2e3]));
...
* 随机播放是否开启
*/
const isShuffleActiveAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\controlsAtoms.ts/isShuffleActiveAtom", (0, jotai.atom)(false));
/**
* 当前的重复播放模式
*/
isShuffleActiveAtom.debugLabel = "isShuffleActiveAtom";
const repeatModeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\controlsAtoms.ts/repeatModeAtom", (0, jotai.atom)("off"));
/**
* 随机按钮是否可用
*/
repeatModeAtom.debugLabel = "repeatModeAtom";
const isShuffleEnabledAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\controlsAtoms.ts/isShuffleEnabledAtom", (0, jotai.atom)(true));
/**
* 重复按钮是否可用
*/
isShuffleEnabledAtom.debugLabel = "isShuffleEnabledAtom";
const isRepeatEnabledAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\controlsAtoms.ts/isRepeatEnabledAtom", (0, jotai.atom)(true));
/**
* 切换随机播放模式的动作
*/
isRepeatEnabledAtom.debugLabel = "isRepeatEnabledAtom";
const toggleShuffleActionAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\controlsAtoms.ts/toggleShuffleActionAtom", (0, jotai.atom)(null, (get) => {
...
const cycleRepeatModeActionAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\controlsAtoms.ts/cycleRepeatModeActionAtom", (0, jotai.atom)(null, (get) => {
...
* 当前播放歌曲的 ID
*/
const musicIdAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicIdAtom", (0, jotai.atom)(""));
/**
* 当前播放的音乐名称
*/
musicIdAtom.debugLabel = "musicIdAtom";
const musicNameAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicNameAtom", (0, jotai.atom)("未知歌曲"));
/**
* 当前播放的音乐创作者列表
*/
musicNameAtom.debugLabel = "musicNameAtom";
const musicArtistsAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicArtistsAtom", (0, jotai.atom)([{
	name: "未知创作者",
	id: "unknown"
}]));
/**
...
const musicAlbumNameAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicAlbumNameAtom", (0, jotai.atom)("未知专辑"));
/**
* 当前播放的音乐专辑封面 URL
*
* 除了图片也可以是视频资源
...
const musicCoverAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicCoverAtom", (0, jotai.atom)(""));
/**
* 当前播放的音乐专辑封面资源是否为视频
*/
musicCoverAtom.debugLabel = "musicCoverAtom";
const musicCoverIsVideoAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicCoverIsVideoAtom", (0, jotai.atom)(false));
/**
* 当前音乐的总时长，单位为毫秒
*/
musicCoverIsVideoAtom.debugLabel = "musicCoverIsVideoAtom";
const musicDurationAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicDurationAtom", (0, jotai.atom)(0));
/**
* 当前音乐是否正在播放
*/
musicDurationAtom.debugLabel = "musicDurationAtom";
const musicPlayingAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicPlayingAtom", (0, jotai.atom)(false));
/**
* 当前音乐的播放进度，单位为毫秒
*/
musicPlayingAtom.debugLabel = "musicPlayingAtom";
const musicPlayingPositionAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicPlayingPositionAtom", (0, jotai.atom)(0));
/**
* 当前播放的音乐音量大小，范围在 [0.0-1.0] 之间
*/
musicPlayingPositionAtom.debugLabel = "musicPlayingPositionAtom";
const musicVolumeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicVolumeAtom", (0, jotai_utils.atomWithStorage)("amll-react-full.musicVolumeAtom", .5, void 0, { getOnInit: true }));
/**
* 当前播放的音乐的歌词数据
*/
musicVolumeAtom.debugLabel = "musicVolumeAtom";
const musicLyricLinesAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicLyricLinesAtom", (0, jotai.atom)([]));
/**
* 当前音乐的音质信息
*/
musicLyricLinesAtom.debugLabel = "musicLyricLinesAtom";
const musicQualityAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicQualityAtom", (0, jotai.atom)({
	type: "none",
	codec: "unknown",
	channels: 2,
	sampleRate: 44100,
...
const musicQualityTagAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/musicQualityTagAtom", (0, jotai.atom)(null));
/**
* 用于音频可视化频谱图的实时频域数据
*/
musicQualityTagAtom.debugLabel = "musicQualityTagAtom";
const fftDataAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/fftDataAtom", (0, jotai.atom)([]));
/**
...
const lowFreqVolumeAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\states\\dataAtoms.ts/lowFreqVolumeAtom", (0, jotai.atom)(1));
...
const manualSeekTriggerAtom = globalThis.jotaiAtomCache.get("C:\\GitHub\\applemusic-like-lyrics\\packages\\react-full\\src\\components\\PrebuiltLyricPlayer\\index.tsx/manualSeekTriggerAtom", (0, jotai.atom)(null));
